...
export default function LeaderboardPage() {
  ...
  return (
    <div className="relative min-h-screen text-frost-white flex flex-col">
      <AuroraBackground />
      <Snowfall />
      ...
      {/* ---------------- Main ---------------- */}
      <main className="flex-1 max-w-5xl mx-auto w-full px-4 sm:px-6 pt-4 sm:pt-8 pb-16">

        {/* Hero */}
        <section className="animate-fade-up text-center mb-10 sm:mb-12">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-frost-ice/[0.08] ring-1 ring-frost-ice/20 text-sky-300 text-[11px] font-semibold uppercase tracking-[0.18em]">
            <Snowflake className="w-3.5 h-3.5" />
            Live tracker · {getLegendDayLabel()}
          </div>
          <h1 className="mt-5 font-podium font-bold uppercase tracking-tight text-4xl sm:text-6xl leading-[0.95]">
          ...
          <p className="mt-4 text-sm sm:text-base text-frost-white/60 font-inter max-w-xl mx-auto">
            ...
            <section className="animate-fade-up rounded-3xl ring-1 ring-white/[0.07] bg-white/[0.02] backdrop-blur-sm overflow-hidden" style={{ animationDelay: '250ms' }}>
              <div className="flex items-center justify-between px-5 py-3.5 border-b border-white/[0.06]">
                <div className="flex items-center gap-2">
                  <Medal className="w-4 h-4 text-frost-ice" />
